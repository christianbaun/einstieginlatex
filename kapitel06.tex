...
\index{Tabellen!Gleitobjekt}
\index{Gleitobjekt}
\index[cmd]{\texttt{\textbackslash table}}
...
Der in diesem Dokument häufig verwendete Platzierungsparameter \verb|[H]| erzwingt die Platzierung an der Stelle im Fließtext, wo das Gleitobjekt vorkommt. Der Parameter stammt aus dem Erweiterungspaket \verb|float|, das mit dem Befehl \verb|\usepackage{float}| in der Präambel der Quelldatei eingebunden werden kann.
...
\verb|\totalnumber|\index[cmd]{\texttt{\textbackslash totalnumber}}, 
\verb|\topnumber|\index[cmd]{\texttt{\textbackslash topnumber}}, 
\verb|\bottomnumber|\index[cmd]{\texttt{\textbackslash bottomnumber}}, 
\verb|\topfraction|\index[cmd]{\texttt{\textbackslash topfraction}}
und \verb|\textfraction|\index[cmd]{\texttt{\textbackslash textfraction}}
beeinflusst werden (siehe Tabelle~\ref{tab:LängenbefehleGleitumgebungen} für eine Auswahl dieser Längenbefehle). 


\begin{table}[h!tb]
	\centering
	\caption{Längenbefehlen zur Beeinflussung der Positionierung von Gleitobjekten}
...
\verb|\renewcommand|\index[cmd]{\texttt{\textbackslash renewcommand}} geändert werden. Folgendes Beispiel Ändert das Verhalten des \LaTeX-Compilers dahingehend, das bis zu fünf Gleitumgebungen pro Seite positioniert werden:
...
Mit dem Befehl \verb!\caption{!\textsl{Tabellenüberschrift}\verb!}!\index[cmd]{\texttt{\textbackslash caption}} geschieht die Definition der Tabellenüberschrift\index{Tabellenüberschrift}. Auch diese Fähigkeit setzt die Einbettung der Tabelle in einem \verb!table!-Gleitobjekt voraus. 
...
\begin{table}[h!tb]
\centering
 \caption{Zeilenübergreifendes Zusammenfassen von Feldern einer Tabelle}
...
\begin{table}[h!tb]
\centering
\caption{Horizontale Linien mit fast beliebiger Breite in Tabellen}
